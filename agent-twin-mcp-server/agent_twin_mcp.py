#!/usr/bin/env python3
"""
agent-twin-mcp - FastAPI HTTP Service
Port: 7101
"""
import os
...
service = AgentTwinMcpMCPService()
...
@app.get("/info")
async def info():
    return {"name": "agent-twin-mcp", "version": "1.0", "tools": len(service.tools)}

@app.get("/")
async def root():
    return {"service": "agent-twin-mcp", "version": "1.0"}
