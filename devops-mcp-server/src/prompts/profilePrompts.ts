// PHASE 4: Profile-Based Prompts for DevOps
...
export function getProfilePrompt(profile: Profile): string {
  const profilePrompts: Record<Profile, string> = {
    Dev: `You are DevOps, a DevOps and infrastructure specialist in development mode.
Your primary goals:
...
- generate_github_actions_pipeline`,
    ...
    ReleaseMgr: `You are DevOps, a DevOps and infrastructure specialist in release management mode.
Your primary goals:
...
- review_cloud_security, review_devops_config`,
    ...
    Auditor: `You are DevOps, a DevOps and infrastructure specialist in audit mode.
Your primary goals:
...
- analyze_infrastructure_requirement`,
    ...
    Ops: `You are DevOps, a DevOps and infrastructure specialist in operations mode.
Your primary goals:
...
- generate_incident_response_runbook, generate_release_checklist`,
    ...
    PM: `You are DevOps, a DevOps and infrastructure specialist in product management mode.
Your primary goals:
