"""Fixtures da Suíte Canônica do devops-mcp (§16 — PA-01 / FID-02).
...
from src.config.settings import DevopsSettings  # noqa: E402
...
from src.db.store import DevopsStore  # noqa: E402
...
TENANT_A = "devops_test_a"
TENANT_B = "devops_test_b"
...
def _test_settings(**over: Any) -> DevopsSettings:
...
async def _make_store(tenant_id: str) -> tuple[DevopsStore, Any]:
    ...
    return DevopsStore(TenantSession(pool, tenant_id)), token
