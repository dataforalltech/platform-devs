-- =============================================================================
-- gateway-mapping.sql — registro DECLARATIVO (pull-based) do devops-mcp no
...
-- prefixo 'platform-' → 'devops-mcp', e audience = 'mcp:devops-mcp'. O PEP do
-- sidecar (MCP_TWIN_AUDIENCE) re-verifica o inner token EXATAMENTE nessa audiência.
-- name_microservice='platform-devops-mcp' ⇒ audience esperada 'mcp:devops-mcp'.
...
VALUES
  ('platform-devops-mcp', NULL, '/v1/health', 30,
   'mcp_http', 'http://platform-devops-mcp:7100', '/mcp/tools/list', '/mcp/tools/call', 'mcp')
...
--     FROM ADMIN_DATAFORALL.GATEWAY_MAPPING WHERE name_microservice='platform-devops-mcp';
--   -- audiência derivada esperada: mcp:devops-mcp
