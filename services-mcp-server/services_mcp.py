#!/usr/bin/env python3
"""
services-mcp - FastAPI HTTP Service
Port: 7107
"""
import os
...
@app.get("/info")
async def info():
    return {"name": "services-mcp", "version": "1.0", "tools": len(service.tools)}

@app.get("/")
async def root():
    return {"service": "services-mcp", "version": "1.0"}

if __name__ == "__main__":
    import uvicorn
    port = int(os.environ.get("PORT", 7107))
