#!/usr/bin/env python3
"""
cache-mcp - FastAPI HTTP Service
Port: 7116
"""
import os
...
@app.get("/info")
async def info():
    return {"name": "cache-mcp", "version": "1.0", "tools": len(service.tools)}

@app.get("/")
async def root():
    return {"service": "cache-mcp", "version": "1.0"}

if __name__ == "__main__":
    import uvicorn
    port = int(os.environ.get("PORT", 7116))
