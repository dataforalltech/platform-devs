...
`product-owner-mcp` é uma persona **compute-only** (gera artefatos de produto a partir
...
# namespace canônico = name_microservice ('platform-product-owner-mcp') menos o prefixo
