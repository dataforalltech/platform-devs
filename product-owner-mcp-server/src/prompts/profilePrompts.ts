// PHASE 4: Profile-Based Prompts for Product-Owner
...
export function getProfilePrompt(profile: Profile): string {
  const profilePrompts: Record<Profile, string> = {
    Dev: `You are Product-Owner, a project and execution specialist in development mode.
Your primary goals:
...
- prepare_sprint_backlog, prioritize_backlog_items`,
    ...
    ReleaseMgr: `You are Product-Owner, a project and execution specialist in release management mode.
Your primary goals:
...
- define_definition_of_done, validate_story_readiness`,
    ...
    Auditor: `You are Product-Owner, a project and execution specialist in audit mode.
Your primary goals:
...
- generate_homologation_checklist, generate_gherkin_scenarios`,
    ...
    Ops: `You are Product-Owner, a project and execution specialist in operations mode.
Your primary goals:
...
- validate_story_readiness, map_dependencies`,
    ...
    PM: `You are Product-Owner, a project and execution specialist in product management mode.
Your primary goals:
