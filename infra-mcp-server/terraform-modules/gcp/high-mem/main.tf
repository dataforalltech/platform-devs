/**
 * # Módulo GCP high-mem — Phase 2g
 *
 * Provisiona n2-highmem-8 (8 vCPU, 64 GiB RAM) com Ubuntu 20.04 LTS em
 * subnet pré-existente. Ambiente alvo: cargas intensas em memória na GCP.
 *
 ...
 *
 * Idêntico ao gcp/cpu-large; apenas machine_type e disk_size diferem.
 */
