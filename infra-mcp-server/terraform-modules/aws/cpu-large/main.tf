/**
 * # Módulo AWS cpu-large — Phase 2e
 *
 * Provisiona EC2 m5.2xlarge com Ubuntu 20.04 LTS em subnet pré-existente.
 * Ambiente alvo: DEV / HML (cargas intensas em CPU e memória).
 *
 * Variáveis obrigatórias (via TF_VAR_xxx):
 *   TF_VAR_subnet_id, TF_VAR_vpc_id, TF_VAR_ssh_public_key
 *
 * Idêntico ao aws/cpu-small; apenas instance_type e disk_size diferem.
