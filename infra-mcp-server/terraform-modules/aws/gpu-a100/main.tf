/**
 * # Módulo AWS gpu-a100 — Phase 2g
 *
 * Provisiona EC2 p3.2xlarge (1x Tesla V100 16 GB, 8 vCPU, 61 GiB RAM) com
 ...
 *
 * Idêntico ao aws/cpu-large; apenas instance_type, disk_size e tags diferem.
