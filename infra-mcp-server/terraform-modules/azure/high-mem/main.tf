/**
 * # Módulo Azure high-mem — Phase 2g
 *
 * Provisiona Standard_E8s_v3 (8 vCPU, 64 GiB RAM) com Ubuntu 20.04 LTS em
 * subnet pré-existente. Ambiente alvo: cargas intensas em memória PROD.
 *
