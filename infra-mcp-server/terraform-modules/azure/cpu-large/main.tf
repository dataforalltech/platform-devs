/**
 * # Módulo Azure cpu-large — Phase 2e
 *
 * Provisiona Standard_D8s_v3 com Ubuntu 20.04 LTS em subnet pré-existente.
 * Ambiente alvo: PROD (cargas intensas).
 *
 * Variáveis obrigatórias (via TF_VAR_xxx):
 *   TF_VAR_resource_group, TF_VAR_subnet_id, TF_VAR_admin_ssh_public_key
 *
 * Idêntico ao azure/cpu-small; apenas vm_size e disk_size diferem.
 */
