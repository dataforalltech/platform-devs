...
class AllocatorStore:
    ...
    def _on_vm_failed(self, vm_id: str, error: str) -> None:
        ...
        with self._lock:
            ...
            vm_row = self._con.execute("SELECT spec FROM vms WHERE vm_id=?", (vm_id,)).fetchone()
    ...
    def _find_preemptable_vms_inside_lock(self, spec_cost: float) -> list[sqlite3.Row]:
    ...
    def _preempt_vms_inside_lock(self, vms: list[sqlite3.Row], reason: str) -> None:
