#!/usr/bin/env python3
"""
infra-mcp - FastAPI HTTP Service
Port: 7106
"""
import os
...
@app.get("/info")
async def info():
    return {"name": "infra-mcp", "version": "1.0", "tools": len(service.tools)}

@app.get("/")
async def root():
    return {"service": "infra-mcp", "version": "1.0"}

if __name__ == "__main__":
    import uvicorn
    port = int(os.environ.get("PORT", 7106))
