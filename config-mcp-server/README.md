...
config de workspace a partir de um **ConfigStore encriptado** (arquivo Fernet local).
Não há backend REST/Trinity — o store É o backend, então não há `ServiceApiClient`.
