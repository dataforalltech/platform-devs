"""Fixtures da Suíte Canônica do qa-engineer-mcp (§16 — PA-01 / FID-02).
...
from src.config.settings import QAEngineerSettings  # noqa: E402
...
from src.db.store import QAEngineerStore  # noqa: E402
...
TENANT_A = "qa_engineer_test_a"
TENANT_B = "qa_engineer_test_b"
...
def _test_settings(**over: Any) -> QAEngineerSettings:
...
async def _make_store(tenant_id: str) -> tuple[QAEngineerStore, Any]:
    ...
    return QAEngineerStore(TenantSession(pool, tenant_id)), token
