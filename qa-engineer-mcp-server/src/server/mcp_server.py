...
TOOL_REGISTRY: dict[str, tuple[Callable, str, bool]] = {
    # Leitura / análise
    "analyze_quality_requirement": (analyze_quality_requirement, "qa-engineer:read", False),
...
def build_mcp() -> FastMCP:
    mcp = FastMCP(name="qa-engineer-mcp", instructions=SYSTEM_PROMPT, stateless_http=(os.getenv("MCP_STATELESS", "0") == "1"))
