-- =============================================================================
-- gateway-mapping.sql — registro DECLARATIVO (pull-based) do qa-engineer-mcp no
...
-- prefixo 'platform-' → 'qa-engineer-mcp', e audience = 'mcp:qa-engineer-mcp'. O PEP do
-- sidecar (MCP_TWIN_AUDIENCE) re-verifica o inner token EXATAMENTE nessa audiência.
-- name_microservice='platform-qa-engineer-mcp' ⇒ audience esperada 'mcp:qa-engineer-mcp'.
...
VALUES
  ('platform-qa-engineer-mcp', NULL, '/v1/health', 30,
   'mcp_http', 'http://platform-qa-engineer-mcp:7100', '/mcp/tools/list', '/mcp/tools/call', 'mcp')
...
--     FROM ADMIN_DATAFORALL.GATEWAY_MAPPING WHERE name_microservice='platform-qa-engineer-mcp';
--   -- audiência derivada esperada: mcp:qa-engineer-mcp
