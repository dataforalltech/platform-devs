...
import { SecurityStore } from './db/store.js';
import { getSettings } from './config/settings.js';
import { SECURITY_SYSTEM_PROMPT } from './prompts/securityPrompt.js';
...
async function handleListResources() {
  return {
    resources: [
      {
        uri: 'security_system_prompt',
        name: 'Security System Prompt',
        description: 'System prompt for Security agent specializing in security, compliance, and threat modeling',
        mimeType: 'text/plain',
      },
    ],
  };
