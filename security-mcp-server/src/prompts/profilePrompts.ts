// PHASE 4: Profile-Based Prompts for Security
...
export function getProfilePrompt(profile: Profile): string {
  const profilePrompts: Record<Profile, string> = {
    Dev: `You are Security, a security specialist in development mode.
Your primary goals:
...
- scan_dependency_risks, run_security_scan`,
    ...
    ReleaseMgr: `You are Security, a security specialist in release management mode.
Your primary goals:
...
- classify_security_risks, map_attack_surface`,
    ...
    Auditor: `You are Security, a security specialist in audit mode.
Your primary goals:
...
- generate_security_controls, map_attack_surface`,
    ...
    Ops: `You are Security, a security specialist in operations mode.
Your primary goals:
...
- generate_incident_response_runbook, generate_security_backlog`,
    ...
    PM: `You are Security, a security specialist in product management mode.
Your primary goals:
