"""Fixtures da Suíte Canônica do security-mcp (§16 — PA-01 / FID-02).
...
from src.config.settings import SecuritySettings  # noqa: E402
...
from src.db.store import SecurityStore  # noqa: E402
...
TENANT_A = "security_test_a"
TENANT_B = "security_test_b"
...
def _test_settings(**over: Any) -> SecuritySettings:
...
async def _make_store(tenant_id: str) -> tuple[SecurityStore, Any]:
    ...
    return SecurityStore(TenantSession(pool, tenant_id)), token
