-- =============================================================================
-- gateway-mapping.sql — registro DECLARATIVO (pull-based) do docs-mcp no
...
-- prefixo 'platform-' → 'docs-mcp', e audience = 'mcp:docs-mcp'. O PEP do sidecar
-- (MCP_TWIN_AUDIENCE) re-verifica o inner token EXATAMENTE nessa audiência.
-- name_microservice='platform-docs-mcp' ⇒ audience esperada 'mcp:docs-mcp'.
...
VALUES
  ('platform-docs-mcp', NULL, '/v1/health', 30,
   'mcp_http', 'http://platform-docs-mcp:7100', '/mcp/tools/list', '/mcp/tools/call', 'mcp')
...
--     FROM ADMIN_DATAFORALL.GATEWAY_MAPPING WHERE name_microservice='platform-docs-mcp';
--   -- audiência derivada esperada: mcp:docs-mcp
