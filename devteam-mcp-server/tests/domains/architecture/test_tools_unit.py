# Portado de `architecture-mcp-server/tests/test_tools_unit.py` pelo fan-out de testes.
#
...
from src.domains.architecture.tools.architecture_blueprint_tool import build_architecture_proposal
from src.domains.architecture.tools.artifact_tool import save_artifact
from src.domains.architecture.tools.c4_diagram_tool import build_c4_model
from src.domains.architecture.tools.solution_blueprint_tool import build_solution_blueprint
