# Portado de `frontend-mcp-server/tests/test_tools_unit.py` pelo fan-out de testes.
#
...
from src.domains.frontend.tools.artifact_tool import VALID_KINDS, save_artifact
