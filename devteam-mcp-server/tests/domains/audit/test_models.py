# Portado de `audit-mcp-server/tests/test_models.py` pelo fan-out de testes.
#
...
from src.domains.audit.models.criticality import Criticality
from src.domains.audit.models.policy import (
    ApprovalRule,
    AuditResult,
    ChecklistItem,
    CompliancePolicy,
