# Portado de `ai-governance-mcp-server/tests/test_adr.py` pelo fan-out de testes.
#
...
_mod_tools_adr_tool = importlib.import_module("src.domains.ai-governance.tools.adr_tool")
create_adr = _mod_tools_adr_tool.create_adr
