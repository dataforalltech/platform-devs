# Portado de `ai-governance-mcp-server/tests/test_policy.py` pelo fan-out de testes.
#
...
_mod_tools_policy_tool = importlib.import_module("src.domains.ai-governance.tools.policy_tool")
get_contract_change_policy = _mod_tools_policy_tool.get_contract_change_policy
get_fallback_policy = _mod_tools_policy_tool.get_fallback_policy
get_forbidden_actions = _mod_tools_policy_tool.get_forbidden_actions
get_layer_policy = _mod_tools_policy_tool.get_layer_policy
