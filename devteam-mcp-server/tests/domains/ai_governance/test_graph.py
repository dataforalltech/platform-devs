# Portado de `ai-governance-mcp-server/tests/test_graph.py` pelo fan-out de testes.
#
...
_mod_knowledge_ecosystem_graph = importlib.import_module("src.domains.ai-governance.knowledge.ecosystem_graph")
EcosystemGraph = _mod_knowledge_ecosystem_graph.EcosystemGraph
EcosystemGraphError = _mod_knowledge_ecosystem_graph.EcosystemGraphError
_mod_tools_graph_tool = importlib.import_module("src.domains.ai-governance.tools.graph_tool")
GraphUnavailable = _mod_tools_graph_tool.GraphUnavailable
find_consumers_of = _mod_tools_graph_tool.find_consumers_of
find_dependencies_of = _mod_tools_graph_tool.find_dependencies_of
get_service_metadata = _mod_tools_graph_tool.get_service_metadata
query_ecosystem_graph = _mod_tools_graph_tool.query_ecosystem_graph
