# Portado de `ai-governance-mcp-server/tests/test_search.py` pelo fan-out de testes.
#
...
_mod_tools_checklist_tool = importlib.import_module("src.domains.ai-governance.tools.checklist_tool")
get_final_response_template = _mod_tools_checklist_tool.get_final_response_template
_mod_tools_repository_tool = importlib.import_module("src.domains.ai-governance.tools.repository_tool")
search_governance_knowledge = _mod_tools_repository_tool.search_governance_knowledge
