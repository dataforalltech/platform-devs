# Portado de `ai-governance-mcp-server/tests/test_migration.py` pelo fan-out de testes.
#
...
_mod_tools_migration_tool = importlib.import_module("src.domains.ai-governance.tools.migration_tool")
validate_migration = _mod_tools_migration_tool.validate_migration
