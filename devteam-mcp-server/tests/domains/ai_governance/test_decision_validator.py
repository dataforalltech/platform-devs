# Portado de `ai-governance-mcp-server/tests/test_decision_validator.py` pelo fan-out de testes.
#
...
_mod_tools_decision_tool = importlib.import_module("src.domains.ai-governance.tools.decision_tool")
validate_agent_decision = _mod_tools_decision_tool.validate_agent_decision
