# Portado de `ai-governance-mcp-server/tests/test_ownership.py` pelo fan-out de testes.
#
...
_mod_tools_ownership_tool = importlib.import_module("src.domains.ai-governance.tools.ownership_tool")
check_scope = _mod_tools_ownership_tool.check_scope
get_port_map = _mod_tools_ownership_tool.get_port_map
get_service_dependencies = _mod_tools_ownership_tool.get_service_dependencies
get_service_ownership = _mod_tools_ownership_tool.get_service_ownership
validate_lib_change = _mod_tools_ownership_tool.validate_lib_change
