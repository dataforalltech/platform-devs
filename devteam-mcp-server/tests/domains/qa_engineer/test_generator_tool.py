# Portado de `qa-engineer-mcp-server/tests/test_generator_tool.py` pelo fan-out de testes.
#
...
_mod_tools_generator_tool = importlib.import_module("src.domains.qa-engineer.tools.generator_tool")
generate_api_tests = _mod_tools_generator_tool.generate_api_tests
generate_cypress_tests = _mod_tools_generator_tool.generate_cypress_tests
generate_e2e_tests = _mod_tools_generator_tool.generate_e2e_tests
generate_gherkin_scenarios = _mod_tools_generator_tool.generate_gherkin_scenarios
generate_k6_performance_test = _mod_tools_generator_tool.generate_k6_performance_test
generate_playwright_tests = _mod_tools_generator_tool.generate_playwright_tests
generate_quality_gate = _mod_tools_generator_tool.generate_quality_gate
generate_regression_suite = _mod_tools_generator_tool.generate_regression_suite
generate_smoke_test_suite = _mod_tools_generator_tool.generate_smoke_test_suite
generate_uat_checklist = _mod_tools_generator_tool.generate_uat_checklist
generate_unit_tests = _mod_tools_generator_tool.generate_unit_tests
