# Portado de `dev-twin-mcp-server/tests/test_environment_context.py` pelo fan-out de testes.
#
...
session_mod = importlib.import_module("src.domains.dev-twin.knowledge.session")
_mod_knowledge_session = importlib.import_module("src.domains.dev-twin.knowledge.session")
_collect_fresh = _mod_knowledge_session._collect_fresh
collect_environment_context = _mod_knowledge_session.collect_environment_context
