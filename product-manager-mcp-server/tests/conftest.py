"""Fixtures da Suíte Canônica do product-manager-mcp (§16 — PA-01 / FID-02).
...
from src.config.settings import ProductManagerSettings  # noqa: E402
...
from src.db.store import ProductManagerStore  # noqa: E402
...
TENANT_A = "product_manager_test_a"
TENANT_B = "product_manager_test_b"
...
def _test_settings(**over: Any) -> ProductManagerSettings:
...
async def _make_store(tenant_id: str) -> tuple[ProductManagerStore, Any]:
    ...
    return ProductManagerStore(TenantSession(pool, tenant_id)), token
...
def mint_token(
    ...
    *,
    ...
    aud: str = "mcp:product-manager-mcp",
    jti: str = "jti-1",
    exp_delta: int = 300,
