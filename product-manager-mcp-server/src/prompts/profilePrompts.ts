// PHASE 4: Profile-Based Prompts for Product-Manager
...
export function getProfilePrompt(profile: Profile): string {
  const profilePrompts: Record<Profile, string> = {
    Dev: `You are Product-Manager, a product strategy specialist in development mode.
Your primary goals:
...
- identify_scope_risks, map_dependencies`,
    ...
    ReleaseMgr: `You are Product-Manager, a product strategy specialist in release management mode.
Your primary goals:
...
- define_product_vision, define_product_metrics`,
    ...
    Auditor: `You are Product-Manager, a product strategy specialist in audit mode.
Your primary goals:
...
- map_user_personas, identify_scope_risks`,
    ...
    Ops: `You are Product-Manager, a product strategy specialist in operations mode.
Your primary goals:
...
- map_user_personas, identify_scope_risks`,
    ...
    PM: `You are Product-Manager, a product strategy specialist in product management mode.
Your primary goals:
