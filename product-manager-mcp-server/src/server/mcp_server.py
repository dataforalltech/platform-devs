...
TOOL_REGISTRY: dict[str, tuple[Callable, str, bool]] = {
    ...
    "generate_go_to_market_brief": (generate_go_to_market_brief, "product-manager:write", False),
...
def build_mcp() -> FastMCP:
    mcp = FastMCP(name="product-manager-mcp", instructions=SYSTEM_PROMPT, stateless_http=(os.getenv("MCP_STATELESS", "0") == "1"))
