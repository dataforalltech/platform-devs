...
os.environ.setdefault("MCP_CONNECTORS_BASE_URL", "http://localhost:8006")
os.environ.setdefault("MCP_CONNECTORS_INTERNAL_TOKEN", "test-token")
os.environ.setdefault("MCP_CONNECTORS_LOG_LEVEL", "INFO")
...
def mock_api_client(monkeypatch: pytest.MonkeyPatch) -> MagicMock:
    ...
    monkeypatch.setattr("src.tools.connectors_tools.api_client", client)
