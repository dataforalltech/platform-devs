...
os.environ.setdefault("MCP_ADMIN_BASE_URL", "http://localhost:8002")
os.environ.setdefault("MCP_ADMIN_INTERNAL_TOKEN", "test-token")
os.environ.setdefault("MCP_ADMIN_LOG_LEVEL", "INFO")
...
def mock_api_client(monkeypatch: pytest.MonkeyPatch) -> MagicMock:
    ...
    monkeypatch.setattr("src.tools.admin_tools.api_client", client)
