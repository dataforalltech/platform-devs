...
os.environ.setdefault("MCP_SCHEDULER_BASE_URL", "http://localhost:8005")
os.environ.setdefault("MCP_SCHEDULER_INTERNAL_TOKEN", "test-token")
os.environ.setdefault("MCP_SCHEDULER_LOG_LEVEL", "INFO")
...
def mock_api_client(monkeypatch: pytest.MonkeyPatch) -> MagicMock:
    ...
    monkeypatch.setattr("src.tools.scheduler_tools.api_client", client)
