...
os.environ.setdefault("MCP_CACHE_BASE_URL", "http://localhost:8025")
os.environ.setdefault("MCP_CACHE_INTERNAL_TOKEN", "test-token")
os.environ.setdefault("MCP_CACHE_LOG_LEVEL", "INFO")
...
def mock_api_client(monkeypatch: pytest.MonkeyPatch) -> MagicMock:
    ...
    monkeypatch.setattr("src.tools.cache_tools.api_client", client)
