...
os.environ.setdefault("MCP_GOVERNANCE_BASE_URL", "http://localhost:8003")
os.environ.setdefault("MCP_GOVERNANCE_INTERNAL_TOKEN", "test-token")
os.environ.setdefault("MCP_GOVERNANCE_LOG_LEVEL", "INFO")
...
def mock_api_client(monkeypatch: pytest.MonkeyPatch) -> MagicMock:
    ...
    monkeypatch.setattr("src.tools.governance_tools.api_client", client)
