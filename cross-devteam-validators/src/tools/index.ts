...
export const TOOL_SCHEMAS: Record<string, ToolSchema> = {
  validate_handoff: {
    ...
    description: 'Validate a handoff between two DevTeam',
    inputSchema: toolSchemas.validate_handoff,
  },
  check_governance: {
    name: 'check_governance',
    description: 'Check governance compliance for a DevTeam',
    inputSchema: toolSchemas.check_governance,
  },
  validate_output: {
    name: 'validate_output',
    description: 'Validate output from a DevTeam against expected schema',
    inputSchema: toolSchemas.validate_output,
  },
  get_validation_rules: {
    name: 'get_validation_rules',
    description: 'Get validation rules for a handoff between two DevTeam',
...
function handleValidateHandoff(args: Record<string, unknown>): string {
  const { from_devteam, to_devteam } = args;
