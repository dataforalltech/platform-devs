"""Fixtures da Suíte Canônica do backend-mcp (§16 — PA-01 / FID-02).
...
from src.config.settings import BackendSettings  # noqa: E402
...
from src.db.store import BackendStore  # noqa: E402
...
TENANT_A = "backend_mcp_test_a"
TENANT_B = "backend_mcp_test_b"
...
def _test_settings(**over: Any) -> BackendSettings:
...
async def _make_store(tenant_id: str) -> tuple[BackendStore, Any]:
    ...
    return BackendStore(TenantSession(pool, tenant_id)), token
