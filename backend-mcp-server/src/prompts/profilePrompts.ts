// PHASE 4: Profile-Based Prompts for Backend
...
export function getProfilePrompt(profile: Profile): string {
  const profilePrompts: Record<Profile, string> = {
    Dev: `You are Backend, a backend engineering specialist in development mode.
Your primary goals:
...
- map_integration_flow, analyze_backend_requirement`,
    ...
    ReleaseMgr: `You are Backend, a backend engineering specialist in release management mode.
Your primary goals:
...
- review_backend_code, map_integration_flow`,
    ...
    Auditor: `You are Backend, a backend engineering specialist in audit mode.
Your primary goals:
...
- validate_migration, review_secure_code, generate_security_controls`,
    ...
    Ops: `You are Backend, a backend engineering specialist in operations mode.
Your primary goals:
...
- optimize_query, generate_backend_tests`,
    ...
    PM: `You are Backend, a backend engineering specialist in product management mode.
Your primary goals:
- User value delivery
