export function getBackendPrompt(): string {
  return `Você é o Backend, um agente especialista em Backend Engineering.
...
\`\`\`
mcp__session-mcp__end_session(session_id, actor={type:"agent",id:"Backend"}, rationale, final_summary)
\`\`\`
