...
# inputSchema MUST ser type=object com properties. Análise/revisão/otimização são
...
_TOOL_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "analyze_backend_requirement": {
        "description": "Analisa requisito de negócio e identifica entidades, permissões, integrações.",
        "capability": "backend-mcp.analyze_backend_requirement",
    ...
    "review_backend_code": {
        ...
        "capability": "backend-mcp.review_backend_code",
    ...
    "optimize_query": {
        ...
        "capability": "backend-mcp.optimize_query",
    ...
    "generate_api_contract": {
        ...
        "capability": "backend-mcp.generate_api_contract",
    ...
    "generate_auth_policy": {
        ...
        "capability": "backend-mcp.generate_auth_policy",
    ...
    "generate_database_schema": {
        ...
        "capability": "backend-mcp.generate_database_schema",
    ...
    "generate_fastapi_router": {
        ...
        "capability": "backend-mcp.generate_fastapi_router",
    ...
    "generate_nestjs_controller": {
        ...
        "capability": "backend-mcp.generate_nestjs_controller",
    ...
    "generate_migration": {
        ...
        "capability": "backend-mcp.generate_migration",
    ...
    "generate_repository_layer": {
        ...
        "capability": "backend-mcp.generate_repository_layer",
    ...
    "generate_service_layer": {
        ...
        "capability": "backend-mcp.generate_service_layer",
    ...
    "generate_openapi_spec": {
        ...
        "capability": "backend-mcp.generate_openapi_spec",
    ...
    "map_integration_flow": {
        ...
        "capability": "backend-mcp.map_integration_flow",
...
# backend-mcp não tem tool tokenless; a liveness é o /v1/health (CI-7).
...
def _dispatch(name: str, args: dict[str, Any]) -> dict[str, Any]:
    ...
    if name == "analyze_backend_requirement":
        return analyze_backend_requirement(
            requirement=args.get("requirement", ""), context=args.get("context")
        )
    if name == "review_backend_code":
        return review_backend_code(
            code=args.get("code", ""), language=args.get("language", ""), focus=args.get("focus")
        )
    ...
    if name == "generate_repository_layer":
        return generate_repository_layer(
            entity=args.get("entity", ""), database=args.get("database", ""), orm=args.get("orm")
        )
...
def build_server() -> tuple[Any, Settings, FastAPI]:
    ...
    settings.enforce_security_invariants()  # fail-fast no boot (STD-SEC-001 / STD-SEC-006)
    configure_logging(settings)  # logging estruturado JSON (STD-OBS-001)
    http_app = _build_http_app(settings)
    _log.info("backend_mcp_ready tools=%d", len(_TOOL_SCHEMAS))
