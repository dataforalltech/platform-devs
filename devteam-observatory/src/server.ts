...
async function handleListResources() {
  return {
    resources: [
      {
        uri: 'devteam_observatory_system_prompt',
        name: 'DevTeam Observatory System Prompt',
        description: 'System prompt for DevTeam Observatory providing dashboards and observability across the ecosystem',
        mimeType: 'text/plain',
      },
    ],
  };
...
async function handleReadResource(request: {
  ...
  if (uri === 'devteam_observatory_system_prompt') {
    return {
      contents: [
        {
          uri: 'devteam_observatory_system_prompt',
          mimeType: 'text/plain',
          text: 'You are a DevTeam Observatory specialist focused on monitoring, dashboards, and observability across the entire DevTeam ecosystem.',
