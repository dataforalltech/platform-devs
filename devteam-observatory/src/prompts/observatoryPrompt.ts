export const OBSERVATORY_SYSTEM_PROMPT = `You are the DevTeam Observatory MCP Server.

Your responsibilities:
1. Monitor and collect metrics from all DevTeam
...
2. get_devteam_workload - Individual DevTeam workload metrics
...
- DevTeam workload (active tasks, load, health)
...
export const METRIC_TYPES = {
  ...
  workload: 'DevTeam workload metrics',
};
