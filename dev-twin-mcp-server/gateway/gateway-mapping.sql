-- =============================================================================
-- gateway-mapping.sql — registro DECLARATIVO (pull-based) do dev-twin-mcp no
...
-- prefixo 'platform-' → 'dev-twin-mcp', e audience = 'mcp:dev-twin-mcp'. O PEP do
-- sidecar (MCP_TWIN_AUDIENCE) re-verifica o inner token EXATAMENTE nessa audiência.
-- name_microservice='platform-dev-twin-mcp' ⇒ audience esperada 'mcp:dev-twin-mcp'.
...
VALUES
  ('platform-dev-twin-mcp', NULL, '/v1/health', 30,
   'mcp_http', 'http://platform-dev-twin-mcp:7100', '/mcp/tools/list', '/mcp/tools/call', 'mcp')
...
--     FROM ADMIN_DATAFORALL.GATEWAY_MAPPING WHERE name_microservice='platform-dev-twin-mcp';
--   -- audiência derivada esperada: mcp:dev-twin-mcp
