"""
Dev-Twin-MCP HTTP Endpoints — PostgreSQL Integration.
...
class DevTwinHTTPEndpoints:
    """HTTP endpoints para dev-twin-mcp com sync PostgreSQL."""
    ...
    def __init__(self, postgres_sync):
        ...
        Args:
            postgres_sync: DevTwinPostgresSync instance
        """
