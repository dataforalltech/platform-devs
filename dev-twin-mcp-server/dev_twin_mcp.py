#!/usr/bin/env python3
"""
dev-twin-mcp - FastAPI HTTP Service
Port: 7101
"""
import os
...
class DevTwinMcpMCPService:
    def __init__(self):
        self.name = "dev-twin-mcp"
...
@app.get("/info")
async def info():
    return {"name": "dev-twin-mcp", "version": "1.0", "tools": len(service.tools)}

@app.get("/")
async def root():
    return {"service": "dev-twin-mcp", "version": "1.0"}
