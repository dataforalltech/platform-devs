...
async function handleListResources() {
  return {
    resources: [
      {
        uri: 'cross_zilla_validators_system_prompt',
        name: 'Cross-Zilla Validators System Prompt',
        description: 'System prompt for Cross-Zilla Validators specializing in handoff validation and governance',
        mimeType: 'text/plain',
      },
    ],
  };
...
async function handleReadResource(request: {
  ...
  if (uri === 'cross_zilla_validators_system_prompt') {
    return {
      contents: [
        {
          uri: 'cross_zilla_validators_system_prompt',
          mimeType: 'text/plain',
          text: 'You are a Cross-Zilla Validators specialist focused on validating handoffs between different Zillas and ensuring governance compliance.',
