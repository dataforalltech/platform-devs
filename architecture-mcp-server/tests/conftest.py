"""Fixtures da Suíte Canônica do architecture-mcp (§16 — PA-01 / FID-02).
...
from src.config.settings import ArchitectureSettings  # noqa: E402
...
from src.db.store import ArchitectureStore  # noqa: E402
...
TENANT_A = "architecture_test_a"
TENANT_B = "architecture_test_b"
...
def _test_settings(**over: Any) -> ArchitectureSettings:
...
async def _make_store(tenant_id: str) -> tuple[ArchitectureStore, Any]:
    ...
    return ArchitectureStore(TenantSession(pool, tenant_id)), token
