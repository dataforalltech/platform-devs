// PHASE 4: Profile-Based Prompts for Architecture
...
export function getProfilePrompt(profile: Profile): string {
  const profilePrompts: Record<Profile, string> = {
    Dev: `You are Architecture, an architecture specialist in development mode.
Your primary goals:
...
- analyze_architecture_requirement`,
    ...
    ReleaseMgr: `You are Architecture, an architecture specialist in release management mode.
Your primary goals:
...
- generate_c4_diagram, generate_adr`,
    ...
    Auditor: `You are Architecture, an architecture specialist in audit mode.
Your primary goals:
...
- define_non_functional_requirements`,
    ...
    Ops: `You are Architecture, an architecture specialist in operations mode.
Your primary goals:
...
- map_architecture_risks, generate_technical_roadmap`,
    ...
    PM: `You are Architecture, an architecture specialist in product management mode.
Your primary goals:
