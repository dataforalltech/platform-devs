...
async function handleListResources() {
  return {
    resources: [
      {
        uri: 'quality_gates_system_prompt',
        name: 'Quality Gates System Prompt',
        description: 'System prompt for Quality Gates System managing automated quality checks and gates',
        mimeType: 'text/plain',
      },
    ],
  };
...
async function handleReadResource(request: {
  ...
  if (uri === 'quality_gates_system_prompt') {
    return {
      contents: [
        {
          uri: 'quality_gates_system_prompt',
          mimeType: 'text/plain',
          text: 'You are a Quality Gates System specialist focused on automated quality checks, test coverage, and CI/CD gates.',
