"""Fixtures da Suíte Canônica do frontend-mcp (§16 — PA-01 / FID-02).
...
from src.config.settings import FrontendSettings  # noqa: E402
...
from src.db.store import FrontendStore  # noqa: E402
...
TENANT_A = "frontend_test_a"
TENANT_B = "frontend_test_b"
...
def _test_settings(**over: Any) -> FrontendSettings:
...
async def _make_store(tenant_id: str) -> tuple[FrontendStore, Any]:
    ...
    return FrontendStore(TenantSession(pool, tenant_id)), token
