-- =============================================================================
-- gateway-mapping.sql — registro DECLARATIVO (pull-based) do ai-governance-mcp no
...
-- prefixo 'platform-' → 'ai-governance-mcp', e audience = 'mcp:ai-governance-mcp'. O PEP do
-- sidecar (MCP_TWIN_AUDIENCE) re-verifica o inner token EXATAMENTE nessa audiência.
-- name_microservice='platform-ai-governance-mcp' ⇒ audience esperada 'mcp:ai-governance-mcp'.
...
VALUES
  ('platform-ai-governance-mcp', NULL, '/v1/health', 30,
   'mcp_http', 'http://platform-ai-governance-mcp:7100', '/mcp/tools/list', '/mcp/tools/call', 'mcp')
...
--     FROM ADMIN_DATAFORALL.GATEWAY_MAPPING WHERE name_microservice='platform-ai-governance-mcp';
--   -- audiência derivada esperada: mcp:ai-governance-mcp
