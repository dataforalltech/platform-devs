...
`load_secret` resolve um segredo (ex.: a credencial/DSN do PostgreSQL) a partir do
Vault QUANDO `VAULT_ADDR` está setado, degradando graciosamente para variável de
