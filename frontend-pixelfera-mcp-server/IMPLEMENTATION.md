...
- ✓ `splitTasks.ts` — Divides work between PixelFera and Frontend
...
- ✓ `src/prompts/index.ts` — Exports 3 system prompts:
  - **Frontend Prompt** — Identity, expertise, responsibilities, workflow, tools, best practices
...
### Port Assignment
- **Port 7097** — Reserved for frontend-pixelfera-mcp-server (see AGENTS.md §47)
...
1. **Integration Testing** — Test with actual Frontend and PixelFera agents
