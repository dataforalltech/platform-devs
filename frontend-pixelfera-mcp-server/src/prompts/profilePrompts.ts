// PHASE 4: Profile-Based Prompts for Frontend
...
export function getProfilePrompt(profile: Profile): string {
  const profilePrompts: Record<Profile, string> = {
    Dev: `You are Frontend, a frontend engineering and design specialist in development mode.
Your primary goals:
...
- run_unit_tests, check_accessibility, run_linter`,
    ...
    ReleaseMgr: `You are Frontend, a frontend engineering and design specialist in release management mode.
Your primary goals:
...
- run_linter, generate_frontend_tests`,
    ...
    Auditor: `You are Frontend, a frontend engineering and design specialist in audit mode.
Your primary goals:
...
- generate_frontend_tests, map_visual_states`,
    ...
    Ops: `You are Frontend, a frontend engineering and design specialist in operations mode.
Your primary goals:
...
- analyze_component_performance (custom)`,
    ...
    PM: `You are Frontend, a frontend engineering and design specialist in product management mode.
Your primary goals:
